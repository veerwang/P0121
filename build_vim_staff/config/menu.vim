...
call venu#addItem(s:programmenu, '添加c/c++头文件标识', ':HeaderguardAdd')
call venu#addItem(s:programmenu, '工程文件浏览', ':NERDTreeToggle')
call venu#addItem(s:programmenu, '文件结构', ':TagbarToggle')
call venu#addItem(s:programmenu, 'Undo树', ':UndotreeToggle')
...
let s:searchmenu = venu#create('搜索')
call venu#addItem(s:searchmenu, '搜索引擎Leader', ':LeaderfFile')
call venu#addItem(s:searchmenu, '搜索引擎Ag', ':Ag')
call venu#addItem(s:searchmenu, '单词翻译', ':call SearchWord()')
